...
public class Controller {
	...
	public String Test(String key,int page) {
		//검색기능,검색어를 받을 매개변수 key
		//페이지변환 int형의 페이지 넘버
		System.out.println(key);
		System.out.println(page);
		String str="";
		try {
			StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/B552657/ErmctInsttInfoInqireService/getParmacyListInfoInqire"); /*URL*/	        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=HRtSF9l%2B9iDrX9QOfocSYjGRaMCKHOEwwQFTB9xyHjkyVWTjZw7%2FwOISNztL%2FPonOqC4nkA813iICxLfaAz1UA%3D%3D"); /*Service Key*/ /*Service Key는 ?가 와야함*/
